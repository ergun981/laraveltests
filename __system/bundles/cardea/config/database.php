...
return array(
	...
	*/
	...
	'default' => Config::get('project.dir'),
	...
	*/
	...
	'connections' => array(
		...
		'dermazone' => array(
			'driver'   => 'mysql',
			'host'     => 'localhost',
			'database' => 'dzone_uss24n10',
			'username' => 'dzone_usic18m10',
			'password' => 'V28KG+)B5&5$',
			'charset'  => 'utf8',
			'prefix'   => '',
		),
		...
		'norozone' => array(
			'driver'   => 'mysql',
			'host'     => 'localhost',
			'database' => 'norozone_ubb16k10',
			'username' => 'norozone_ub28s08',
			'password' => 'Z6ZN)![mdu8M',
			'charset'  => 'utf8',
			'prefix'   => '',
		),
		...
		'psikezone' => array(
			'driver'   => 'mysql',
			'host'     => 'localhost',
			'database' => 'pzone_uvy21k10',
			'username' => 'pzone_uvtc27n12',
			'password' => '^V^NW56eHHeG',
			'charset'  => 'utf8',
			'prefix'   => '',
		),
