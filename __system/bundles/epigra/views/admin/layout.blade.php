				...
				<div class="navbar navbar-fixed-top">
						...
						<div class="container">
							...
							<div id="fade-menu" class="pull-left">
								<ul class="clearfix" id="mobile-nav">
									<li><a href="{{ URL::to('admin/dashboard') }} "><i class="icon icon-th-large icon-white"></i> Dashboard</a>
										...
										<li><a href="#"><i class="icon icon-bookmark icon-white"></i> Forum</a>
											<ul>
												<li>
													{{ HTML::link_to_action('epigra::admin.forum.categories@index', 'Kategoriler')}}
												</li>
												<li>
									...
									<div class="span5">
										<nav class="nav-icons">
											<ul>
												...
												<li><a href="{{url('admin/olgular/unapproved')}}" class="ptip_s" title="Olgu"><i class="icsw16-tags-2"></i><span class="badge badge-info">{{$c_olgu}}</span></a></li>
												<li><a href="{{url('admin/forum/topics/unapproved_list')}}" class="ptip_s" title="Forum Konu"><i class="icsw16-create-write"></i><span class="badge badge-info">{{$c_forum}}</span></a></li>
												<li><a href="{{url('admin/muhabir-haber/unapproved_authors')}}" class="ptip_s" title="Muhabir"><i class="icsw16-admin-user"></i><span class="badge badge-important">{{$c_muhabir}}</span></a></li>
												<li><a href="{{url('admin/muhabir-haber')}}"> <span class="ptip_s" title="Muhabir-Haber"><i class="icsw16-file-cabinet"></i><span class="badge badge-important">{{$c_haber}}</span></a></li>
					...
					<footer>
						<div class="container">
							<div class="row">
								<div class="span12">
									<div>&copy; Epigra <?php echo date('Y');?> - <?php echo Config::get('epigra.fwname');?> v.<?php echo Config::get('epigra.version'); ?></div>
								</div>
							</div>
						</div>
					</footer>
